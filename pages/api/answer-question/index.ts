...
async function handleQuestion(req: NextApiRequest, res: NextApiResponse) {
    try {
        ...
        if (!stats.namespaces || stats.namespaces[`file-${fileId}-transcript-${transcriptId}`] === undefined) {
            console.log("Embeddings for the transcript not found in Pinecone. Creating embeddings...");
            try {
        ...
        console.log("Embeddings for the transcript found in Pinecone. Retrieving embeddings...");
