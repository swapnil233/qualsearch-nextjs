...
async function handlePost(
    ...
    const { question, history, fileId, transcriptId } = req.body as IPostRequestBody;
    ...
    try {
        ...
        res.status(HttpStatus.InternalServerError).json({ error: error.message || 'Something went wrong' });
    }
}
